...
ksemillas <- c(100316, 201982, 290909, 261977, 876543) # reemplazar por las propias semillas
...
param_basicos <- list(
  ...
  "minsplit" = 2, # minima cantidad de registros en un nodo para hacer el split (anrs use 400)
  "minbucket" = 1, # minima cantidad de registros en una hoja (antes 440)
  "maxdepth" = 20 # profundidad máxima del arbol (antes 5)
)
