...
# aqui se alica balanceo mediante scale_pos_weight!!!!!!!!!!!!!!
...
PARAM <- list()
PARAM$experimento <- "HT7510_mix"

PARAM$exp_input <- "TS7410_mix"

# En caso que se haga cross validation, se usa esta cantidad de folds
PARAM$lgb_crossvalidation_folds <- 5

PARAM$lgb_semilla <- 290909 # cambiar por su propia semilla
...
PARAM$lgb_basicos <- list(
  ...
  is_unbalance = FALSE, # lo modifique para que balance el peso de los continua y los no continua!!!!!!!!
  scale_pos_weight = 1.0, # scale_pos_weight > 0.0
  #scale_pos_weight = 1 - ( [number of positive samples / total samples])
  # 1 - (850 / 159828) = 0.9947
