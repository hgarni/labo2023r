...
PARAM <- list()
PARAM$experimento <- "FE7310_WF_01"

PARAM$exp_input <- "DR7210_WF_01"
...
PARAM$RandomForest$semilla <- 290909 # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla <- 290909
